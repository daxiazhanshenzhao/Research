...
public class CTech extends AbstractTech {
    public CTech() {
        super(Research.asResource("c_tech"));
    }
    ...
    public TechBuilder getTechBuilder() {
        return TechBuilder.Builder()
                .addStage(3)
                .addParent(TechInit.B_TECH.getId())
                .addRecipe(RecipeWrapper.Craft(ResourceLocation.withDefaultNamespace("crafting_table")))
                .build();
    }
}
