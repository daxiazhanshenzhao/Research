...
public class ResearchPluginFinder {

    private static final Logger LOGGER = LogManager.getLogger();
    private ResearchPluginFinder() {

    }

    public static List<ResearchPlugin> getModPlugins() {
        return getInstances(AutoResearchPlugin.class, ResearchPlugin.class);
    }
